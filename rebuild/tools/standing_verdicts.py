...
def _composed_walk(rules, unit, context):
    ...
    behind_retarget = {
        ...
        and events[index + 1].kind in ("joined", "redrawn")
    }
    behind_join = {
        index + 1
